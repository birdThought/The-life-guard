package com.lifeshs.security.sessionmgr;
...
public class ClientManager {
    ...
    public static void saveClient(String sessionId, Client client) {
	...
	*//**
     ...
     *  @param session
     */
    public void addMianSession(String terminalType, String key,IoSession session){
