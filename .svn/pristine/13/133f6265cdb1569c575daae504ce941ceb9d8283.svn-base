...
<header>
	<div class="banxin clearfix">
		<div class="logo fl">
			<a href="#"> <img src="/static/platform/v2.2.0/images/logo.png" alt="">
			</a>
		</div>
		<ul class="fr clearfix navbar-nav">
			<li><a href="/indexControl.do?index" class="on">首页</a></li>
			<li><a href="/indexControl.do?appIntroduce">APP介绍</a>
				<ul>
					<li><a href="/indexControl.do?appIntroduce#APP_1">机构端</a></li>
					<li><a href="/indexControl.do?appIntroduce#APP_2">用户端</a></li>
				</ul></li>
			<li><a href="/indexControl.do?healthService">产品与服务</a>
				<ul>
			...
			<li><a href="/indexControl.do?aboutUs" class="scroll-link">关于我们</a>
				<ul>
			...
			<li class="showExit none"><a href="/login">用户名</a>
				<ul>
