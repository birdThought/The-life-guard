...
registerController.controller('userManagerController',['$scope', '$rootScope', function ($scope, $rootScope) {
    /** 声明参数*/
    ...
    $scope.listOrders = function () {
    	var url = '/business/listBusinessBindUser/' + $scope.page.pageIndex;
...
//        }
    ...
    $scope.goDetail = function(userId) {
    	$scope.go("check-detail?userId=" + userId);
    }
