...
<div id="window" style="display:none;">
    <div id="loginTitle" style="text-align:center;font-family:'Microsoft YaHei';font-size:44px;bottom:88px;position:relative;display:none">生命守护-客服端后台</div>
        ...
        <div id="login_form">
            <div class="page-content">
                ...
                <div class="input-row">
                    ...
                    <input id="verifyCode" name="verifyCode" placeholder="请输入右侧的验证码" type="text" data-fyll="hackmeplease" class="input fadeIn delay3 verifyCode"/>
                    <p class="verifyCode-show fadeIn">
                        <input type="button" id="checkCode" class="code" onclick="createCode()">
                    </p>
                </div>
                <div class="input-row perspective">
                    <button id="submit" class="button load-btn fadeIn delay4" onclick="login.login()" > <!-- style="width:130px;float: left" -->
                    ...
                    <!-- <button class="button load-btn fadeIn delay4" onclick="login.register()" style="width:130px;float: left;margin-left: 50px">
