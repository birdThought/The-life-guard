...
registerController.controller('accountListController',['$scope', '$rootScope', function ($scope, $rootScope) {
    /** 声明参数*/
...
//    }
    ...
    $scope.listOrders = function () {
    	var url = '/business/listAccount/' + $scope.page.pageIndex;
...
//    	var data = $scope.conditions;
    ...
    $scope.goAccount = function(thisMonth) {
    	$scope.go("check-account?thisMonth=" + thisMonth);
    }
