    ...
    <div class="right_content">
        <div class="right_body" style="min-height: 822px">
            ...
            <div class="param_set" style="margin-top:30px">
                ...
                <span>${mobile}</span>
                <button class="btn" style="color: #3598dc;margin-left:20px;" onclick="VeriMobile1.getMobileVerify(this,${isBindNew})">获取短信验证码</button>
            </div>
            <div class="param_set" style="margin-top:30px">
            ...
            <div class="param_set" style="margin-top:30px">
                ...
                <button class="save" onclick="VeriMobile1.checkMobile(${isBindNew})">下一步</button>
            </div>
        </div>
    </div>
</div>
