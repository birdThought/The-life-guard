...
.layui-layer-content {
 ...
 <div ng-clock class="orderCenter" ng-controller="sportKindController" ng-init="init()" style="padding: 16px 0 0 20px;">
     <div class="titleShow">
     ...
     <div id="orderCenterPopup" class="orderPopup ">
        <section class="clearfix">
         ...
         <section class="clearfix" style="margin-top: 15px;">
            ...
            <input id="sportKind_name" class="doctor-sign Select-Options" placeholder="请输入种类名称" >
        </section>
        ...
        <section class="clearfix"  style="text-align: center; margin-top: 15px;">
            <input style="background-color:#3cbaff;color:#fff;width:120px;height:40px;border-raidus:6px" type="button" ng-class="currentOrder.status == 3 ? 'button_blue_1' : 'button_blue_2'"
                   value="提交数据" ng-click="addsportKind()">
        </section>
    </div> 
      ...
      <div id="orderCenterPopup2" class="orderPopup ">
        <section class="clearfix">
         ...
         <section class="clearfix" style="margin-top: 15px;">
            ...
            <input id="sportKind_name" class="doctor-sign Select-Options" placeholder="修改种类名称" ng-model="edit.name">
        </section>
       
   
        <section class="clearfix"  style="text-align: center; margin-top: 15px;">
            <input style="background-color:#3cbaff;color:#fff;width:120px;height:40px;border-raidus:6px" type="button" ng-class="currentOrder.status == 3 ? 'button_blue_1' : 'button_blue_2'"
                   value="提交数据" ng-click="editsportKind()">
        </section>
    </div>
