...
app.filter('fenToYuan', function () {
    return function (value) {
        ...
        var price = (value/100) + '元';
        return price;
    }
})

app.filter('fenToYuan2', function () {
    return function (value) {
        if (value == null || value == undefined) {
            return '0元';
        }
        return (value/100).toFixed(0) + '元';
    }
})

app.filter('fenToYuan3', function () {
    return function (value) {
        if (value == null || value == undefined) {
            return '0';
        }
...
app.filter('vipUserOrderType', function () {
