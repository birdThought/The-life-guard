registerController.controller('checkDetailController',['$scope', '$rootScope', '$location', function ($scope, $rootScope, $location) {
    /** 声明参数*/
    ...
    $scope.listOrders = function () {
    	var url = '/business/checkExpenseDetail/' + $scope.page.pageIndex;
