 ...
 *  TODO 随机生成验证图片
 *  @author duosheng.mo
 *  @DateTime 2016年5月18日 上午11:48:45
 */
public class RandCodeImageServlet extends HttpServlet {
    ...
    private static final Logger logger = Logger.getLogger(RandCodeImageServlet.class);
    ...
    public void doGet(final HttpServletRequest request,
        ...
        // 取随机产生的认证码(4位数字)
        final String resultCode = RandCodeUtil.randCode();
        ...
        SecurityUtils.getSubject().getSession()
                     .setAttribute(BaseDefine.SESSION_KEY_OF_RAND_CODE,
            resultCode);
