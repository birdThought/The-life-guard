...
<footer id="footer">
    <div class="banxin wrapper">
        <ul>
            ...
            <li>
                <a>
                    <img src="/static/platform/v2.2.0/images/qrcode.png" alt="">
                    <h4>生命守护公众号</h4>
                </a>
            </li>
        </ul>
...
<div id="tanchuanAndroid" style="left: 887.5px; top: 1100px; display: none;">
    <div style="padding: 15px 23px">
        ...
        <a href="http://app.qq.com/#id=detail&amp;appid=1105104088" style="float: left; cursor: pointer">
            <img src="/static/images/android_use.jpg" alt="Andriod版下载" width="95" height="95">
            <p class="p2">Andriod版下载</p>
        </a> 
        <a href="https://itunes.apple.com/us/app/sheng-ming-shou-hu/id1114425655?l=zh&amp;ls=1&amp;mt=8" style="cursor: pointer;float: left">
