    ...
    <section class="banxin container">
        ...
        <div class="main-content vue-content" v-cloak>
            <div class="store-href">
                <a href="#">个体门店主页</a><em>&gt;</em><span>今日订单</span>
            </div>
            <ul class="member-task clearfix">
                <li class="income">
                    <dl>
                        <dt>今日订单</dt>
                        <dd class="count"><em>{{todayOrder}}</em>单</dd>
                ...
                <li class="later-7">
                    <dl>
                        <dt>本月订单</dt>
                        <dd class="count"><em>{{weekOrder}}</em>单</dd>
            ...
            <div class="income-top">
                <div>
                    <div class="data-show clearfix">
                        <ul>
                            <li class="on" @click = "listProfit(1, 'order')">近7天</li>
                            <li @click = "listProfit(2, 'order')">14天</li>
                            <li @click = "listProfit(3, 'order')">30天</li>
                        </ul>
                        <div>
