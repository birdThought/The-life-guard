...
<div class="vue-content" v-cloak>
    ...
    <div class="lastest clearfix">
        ...
        <div class="lastest-content-right">
            <ul>
                <li>体温：<span :class="abnormal(latest.temperature, latest.temperatureArea) ? 'red' : ''" v-html="latest.temperature"></span>℃</li>
            </ul>
        </div>
    </div>
    <div class="history history-data-lists">
        <div class="item clearfix" v-for="h in history">
            ...
            <div class="content">
                <p>
                    <span>体温：<label :class="abnormal(h.temperature, h.temperatureArea) ? 'red' : ''">{{h.temperature}}</label>℃</span>
                </p>
            </div>
        </div>
        <p id="line"></p>
                                ...
                                var objLen = responsive.obj.length;
                                    if(objLen>0){
                                        for(var i = 0; i < responsive.obj.length; i++){
                                                ...
                                                str+="<p><span>体温：<label class=\"" + result_judge(data.temperature,data.temperatureArea) + "\">" + data.temperature + '</label></span>';
                                                str+="</p></div></div>";
                                        }
                                    }else {
                                        me.lock();
