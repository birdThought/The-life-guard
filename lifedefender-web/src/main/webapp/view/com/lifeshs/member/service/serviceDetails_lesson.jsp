...
<head>
    ...
    <title>服务详情</title>
    <link rel="stylesheet" href="/static/css/serviceDetails_lesson.css">
    <script type="text/javascript" src="/static/com/lifeshs/healthService/serviceDetails_lesson.js"></script>
</head>
<body>
        ...
        <div class="right-wrap" style="padding-top: 30px">
            <div class="container fr" style="margin-top: 0">
                ...
                <div class="serviceGroup">
                    <h3>服务课堂</h3>
                    <ul class="groupBtn">
                        <c:forEach items="${data.groupIdAndNameList}" var="item">
                        <li data-groupid="${item.id}">${item.name}</li>
                        </c:forEach>
                    </ul>
                    <c:forEach items="${data.groupList}" var="item">
                    <ul data-groupid="${item.id}" class="serviceDoctor" style="margin-top: 20px; margin-bottom: 0px; display:none;">
                        <li><img src="${item.photo}" /></li>
                        <li>
                            <p style="font-size:16px;">服务师:${item.orgUserNames}</p>
                            <dl>
                                <dt>简介:</dt>
                ...
                <div class="servicePrice">
                    ...
                    <div class="countBtn">
                        <div class="item-amount">
                            <a href="javascript:ServiceControl.addOrDecrease(0)" class="decrease">-</a>
                            <input id="countNumber" type="text" value="1" maxlength="3" class="text" autocomplete="off">
                            <a href="javascript:ServiceControl.addOrDecrease(1)" class="add">+</a>
                        </div>
                ...
                <%-- <div class="service-team">
                    ...
                    <c:if test="${empty data.servers}">
                        <div style="text-align: center;font-size: 16px;padding-top: 30px">该机构服务还未给该服务分配服务师团队</div>
                    </c:if>
                    <c:forEach items="${data.servers}" var="item">
                        <ul class="serviceDoctor">
                            <li><img src="${item.photo}" alt="">
                            </li>
                            <li>
                                <p>
                            ...
                            <li style="display: none;">
                                <div>
                                    ...
                                    <p> 问诊数：<span>2131</span></p>
                                    <p>综合评分：<span>4.0</span></p>
                                </div>
                            </li>
                        </ul>
                    </c:forEach>
