...
<section class="persondetails">
    <div class="container">
        <div class="detail-top">
            <p>您现在的位置   |  专业服务  |  精英医师讲座  | <span>于保平老师</span> </p>
        </div>
        <div class="detail-content">
            <div class="detail-content-top">
                <h1>医生</h1>
            </div>
            <div class="detail-content-bottom clearfix">
                <section class="left">
                    <h1>专家简介</h1>
                    <p>
                        曾任某大学老师，热爱营养学，多次开展营养健康讲座。现任葆婴公司执行经销商
                    </p>
                    <p style="margin-top:2rem;">
                        <span style="font-weight: bold;font-size: 1.6rem;">主讲人机构背景资料：</span>葆婴有限公司是一家专业从事健康理念传播及健康产品研发、生产、销售和服务，专门为孕妇、婴幼儿和家庭健康提供营养健康食品和全面系统健康资讯的外商独资企业。
                    </p>
                </section>
                <section class="right">
                   <img class="img-responsive center-block" src="/static/officialwebsite/v2.5.0/images/bg002.png" alt="">
					<h2 style="color: #333;font-size: 3rem;letter-spacing: 1px;text-align: center;font-weight: normal;margin-top:2rem;">于保平老师</h2>
                </section>
            </div>
        </div>
    </div>
