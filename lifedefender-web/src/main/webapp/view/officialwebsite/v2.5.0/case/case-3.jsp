...
<head>
    ...
    <title>中医养生会员健康管理系统</title>
    <style>.middle-main-content{height:13rem;}@media screen and (max-width:650px){.middle-main-content{height:auto;}}</style>
...
<article class="content container">
    <div class="content-top">
        <p>您现在的位置  |  合作案例  |  <span>中医养生会员健康管理系统</span></p>
    </div>
    <div class="content-bottom">
        ...
        <div class="content-bottom-middle">
            <div class="row">
                <ul class="middle-fist">
                    <li class="">
                        <h5>项目背景</h5>
                        <p>很多中医设立自己的门店为老顾客看诊，却苦于没有一个好的会员健康管理工具为顾客们提供更高端、精准、个性化、定制化的服务拉开个体差异。利用“生命守护”会员健康管理系统可以满足中医们的这个目标，它是长远维系医患关系的桥梁，并利于医师线上做自我品牌的推广和运营，让更多人认识医生，扩大其知名度和提升服务辐射范围。个性化的健康方法定制将极大的促进医师的服务水平，满足高端消费者的需求。本系统同样满足其他个体医生或者全科医师使用。</p>
                    </li>
                    <li >
                        <!--192.168.0.105-->
                        <p>
                            针对上述难题，生命守护制定了中医养生会员健康管理系统
                        </p>
                        <section class="middle-main-content clearfix">
                            <div >
                                <dl>
                                    <dt>服务方案</dt>
                                    <dd><i class="iconfont icon-lingxing"></i>会员健康管理系统</dd>

                                </dl>
                            </div>
                            <div>
                                <dl>
                                    <dt><i class="iconfont icon-lingxing"></i>服务内容</dt>
                                    <dd><i class="iconfont icon-lingxing"></i>同时服务近百名会员</dd>
                                    <dd><i class="iconfont icon-lingxing"></i>线上医师服务</dd>
                                    <dd><i class="iconfont icon-lingxing"></i>线上预约</dd>
                                    <dd><i class="iconfont icon-lingxing"></i>向会员推送消息</dd>
                                </dl>
                            </div>
                            <div>
                                <dl>
                                    <dt>服务说明</dt>
                                    <dd><i class="iconfont icon-lingxing"></i>线上互动帮忙解答疑难。</dd>
                                    <dd><i class="iconfont icon-lingxing"></i>向会员推送养生消息或者促销活动资讯。</dd>
                                </dl>
                            </div>
                        </section>
                    ...
                    <li class="">
                        ...
                        <div class="service-list clearfix">
                            <div class="service-list-left" style="width: 100%;">
                                <ul>
                                    <li><i class="iconfont icon-lingxing"></i>提高个人名气，利于形成个人品牌运营</li>
                                    <li><i class="iconfont icon-lingxing"></i>提升创收;提高业务宣传</li>
                                </ul>
                            </div>
                        </div>
                    </li>
