    ...
    $.fn.bigic = function () {
        ...
        Bigic.prototype.show = function(){
            ...
            oImg.onload = function(){
            	/*console.log(this.nImgWid + '  ' + this.nImgHei)
            	if(this.nImgWid > this.nImgHei) {
            		oThis.nImgWid = 500;
            		oThis.nImgHei = 300;
            	} else if(this.nImgWid < this.nImgHei) {
            		oThis.nImgWid = 300;
            		oThis.nImgHei = 500;
            	} else {
            		oThis.nImgWid = 400;
                ...
                $('#LoadingBigic').remove();
                oThis.$popup.parent().append('<div style = "position: fixed; z-index: 90; padding: 10px; width: 800px; height: 532px; top: 10%; left: 30%; display: block;">'+
                		'<img style = "width: 500; height: 300; position: absolute; vertical-align:top; padding: 0px; margin: 0px;" id="imgBigic" class="img-bigic" src="'
                		+ oThis.sImgSrc +'" /></div>');
                oThis.$img = $('#imgBigic');
        ...
        Bigic.prototype.popup = function(){
            var sHtml = '',
                oThis = this;
            // 生成HTML 选中DOM节点
            sHtml += '<div id = "div"><div id="popupBigic" class="popup-bigic" >'  /*height:'+ this.nWinHei +'px; style="width:'+ this.nWinWid +'px;height: 1500px;"*/
        ...
        Bigic.prototype.zoom = function(){
            ...
            this.nWinHei = this.$win.innerWidth;
            this.bMoveX = true;
            this.bMoveY = true;
